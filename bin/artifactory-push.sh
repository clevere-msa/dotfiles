...
UPLOAD_URL="$ARTIFACTORY_URL/$REPO/$ZIP_FN"

echo "/usr/bin/curl --cacert $CERT_FN -H \"X-JFrog-Art-Api:...\" --upload-file $ZIP_FN --url $UPLOAD_URL"
/usr/bin/curl --cacert $CERT_FN -H "X-JFrog-Art-Api:$API_KEY" -T $ZIP_FN $UPLOAD_URL
